...
urlpatterns = [
    ...
    url(r'^(?P<department>[\w.]+)/edit$', department_views.save_update_department, name="update-department"),
    url(r'^(?P<department>[\w.]+)/delete$', department_views.delete_department, name="delete-department"),
]
